...
//DBOpenHelper 继承 SQLiteOpenHelper 需要重写两个方法 以及构造方法
public class DBOpenHelper extends SQLiteOpenHelper {
    public DBOpenHelper(@Nullable Context context) {
        //更改了数据库名称
        super(context, "myaccountapp.db", null, 1);
    }
...
//        db.execSQL(sql);
        sql = "create table accounttb(id integer primary key autoincrement,typename varchar(10),sImageId integer,beizhu varchar(80),money float," +
                "time varchar(60),year interger,month integer,day integer,kind integer)";
        db.execSQL(sql);
    }
